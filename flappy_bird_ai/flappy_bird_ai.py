...
class Pipes:
    ...
    VEL = 5  # speed of the pipes moving towards the bird
    ...
    def __init__(self, x):
        ...
        # keep track of where bottom and top of pipe will be drawn
        self.top = 0
        self.bottom = 0
        self.PIPE_TOP = pygame.transform.flip(PIPE_IMG, False, True)  # flips the pipe image upside-down
        self.PIPE_BOTTOM = PIPE_IMG

        self.passed = False  # for collision, parameter for if the bird passes a pipe
        self.set_height()  # set height of the pipe / randomly define it
    ...
    # pixel perfect collision class (not a simple boxed collision)
...
class Base:
    ...
    def move(self):
        ...
        # cycle back the base image if its off screen
...
def main():
    bird = Bird(230, 350)   # bird pos
    base = Base(730)        # base height
    pipes = [Pipes(700)]
